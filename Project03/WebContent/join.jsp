...
<head>
	<%
		...
		if(userID != null){
			...
			session.setAttribute("messageContent", "현재 로그인이 되어 있는 상탣입니다.");
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width: 110px;"><button type="button" class="btn btn-primary" onclick="registerCheckFunction();">중복 확인</button></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>비밀번호</h5></td>
						<td colspan="2"><input type="password" onkeyup="passwordCheckFunction();" class="form-control" id="userPW1" name="userPW1" maxlength="20" placeholder="비밀번호를 입력하세요"></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>비밀번호 확인</h5></td>
						<td colspan="2"><input type="password" onkeyup="passwordCheckFunction();" class="form-control" id="userPW2" name="userPW2" maxlength="20" placeholder="비밀번호를 입력하세요"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input type="number" class="form-control" id="userAge" name="userAge" maxlength="3" placeholder="나이를 입력하세요"></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="text-align: left" colspan="3">
							<h5 style="color: red;" id="passwordCheckMessage"></h5> <input class="btn btn-primary pull-right" type="submit" value="회원가입">
						</td>
					</tr>
				</tbody>
			</table>

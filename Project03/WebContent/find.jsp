		...
		$.ajax({
			...
			success: function(result){
				if(result == 0){
					...
					$('#checkMessage').html('찾으시는 아이디가 없습니다.');
		...
		<table class="table table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="form-control" id="findID" name="findID" maxlength="20" placeholder="아이디"></td>
				</tr>
				<tr>
					<td colspan="2">
						<button type="button" class="btn btn-primary pull-right" onclick="findFunction();">검색</button>
					</td>
				</tr>
			</tbody>
		</table>
